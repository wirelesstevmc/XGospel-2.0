...
if [ -f xgospel ]; then
    echo "Build successful! 64-bit binary created: xgospel"
    ls -la xgospel
    file xgospel
else
    echo "Build failed!"
